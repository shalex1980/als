          ...
          <div className="container">
            ...
            <div className={styles.about_wrap}>
               <article className={styles.about_tx}>
                  <p>Our company has four years' experience in the USA market.
                     We specialize in creating additional sales and increasing
                     conversions through listing optimizations across multiple platforms (Shopify, Amazon).  
                     We sell products on our eCommerce store.
