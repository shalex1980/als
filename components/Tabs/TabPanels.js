...
const TabPanels = (props) => {
    return (
       ...
       <TabPanel actTab={props.indexTab} index={0}>
        <article className={styles.tabpanel_wrap}>
           <div className={styles.tabpanel_tx}>
             <h4>Online store</h4>
             <p>Online buying has become an essential part of many people's lives. 
               ...
               Shopping online is just like heading out to the store. 
               You can often buy the same products online as available in a brick-and-mortar store and can sometimes score better sales.
              </p>
           </div>
      ...
      We use third-party services to take photos of the required quality and rules.</p>
         ...
         <article className={styles.tabpanel_wrap}>
           <div className={styles.tabpanel_tx}>
             ...
             <p>The key product features are integral to conversion provide customers with a snapshot view of the product. 
                We use them to call out the most crucial information about your product that you want to make sure customers read.</p>
           </div>
           <div className={styles.tabpanel_img}>
            <Image 
         ...
         <article className={styles.tabpanel_wrap}>
           ...
           <div className={`${styles.tabpanel_tx} tx_right`}>
             <h4>Descriptions</h4>
             <p>The product description is a way to draw organic traffic through indexing and help create a better customer shopping experience. 
               Customers must know what they will be receiving when they make a purchase, and a good description vibrantly describes and sells and sets proper expectations for the product.</p>
           </div>
    ...
    Using Amazon services and third-party programs, we predict the required quantity of goods always in stock.</p>
           </div>
           <div className={styles.tabpanel_img}>
            <Image 
        ...
        <article className={styles.tabpanel_wrap}>
            ...
            <div className={`${styles.tabpanel_tx} tx_right`}>
             ...
             <p>We’re here for customers when their orders don’t go as planned. Each step of the customer service process is handled to keep shoppers happy and your brand integrity intact.
             </p>
            </div>
       ...
       <article className={styles.tabpanel_wrap}>
           <div className={styles.tabpanel_tx}>
            ...
            <p>
            "The most effective content is supported and validated by positive reviews." This one is about social proof. Product reviews, both the quantity of them and the quality, are huge influencers on whether people will buy a product. Many people compare products not only on Amazon is based on reviews, but they will even pull up their phone and check Amazon reviews before they buy the product in-store. That is a big thing companies should be aware of! So, reviews are essential. We firmly believe that all reviews should be monitored and responded to. This shows a level of care, and a strong review follow-up system can be used to curtail the accumulation of poor reviews. We can further increase the review score by going through and requesting removal for feedback that doesn't follow the Amazon guidelines. 
            Typically, these types of reviews are related to product fulfillment and violate Amazon's review guidelines.
            </p>
        ...
        <article className={styles.tabpanel_wrap}>
          <div className={styles.tabpanel_img}>
           ...
           <div className={`${styles.tabpanel_tx} tx_right`} >
            ...
            All questions asked by customers — through direct contact or listings — are quickly answered. 
            We build a bridge between our customers and brand owners. 
            </p>
            <ul>
           ...
           <div className={styles.tabpanel_tx}>
              ...
              <p>Working with the brand products on Amazon, we monitor the cleanliness of the product catalog. 
                 We are tracking and removing duplicate listings, monitor the compliance of product information. (
                  Mistakes in titles, inconsistencies in the description, etc.) 
